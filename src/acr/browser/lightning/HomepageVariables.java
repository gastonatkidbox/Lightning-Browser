...
public class HomepageVariables {
	...
	public HomepageVariables(Context context){
	...
	public String getMIDDLE(){ 
		return "\" ></br></br><form onsubmit=\"return search()\" class=\"search_bar\">"
			+ "<input type=\"submit\" id=\"search_submit\" value=\"" + this.context.getResources().getString(R.string.search_hint) + "\" ><span><input class=\"search\" type=\"text\" value=\"\" id=\"search_input\" >"
	...
	public String getEND(){
		return "\" + document.getElementById(\"search_input\").value;document.getElementById(\"search_input\").value = \"\";}return false;}</script></body></html>";
	}
}
